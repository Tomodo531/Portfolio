...
var enemyImg;
var bitFont;
var death = new Audio('http://martinolesen.codes/images/Game/Death.mp3')
var deathPlayed = false;
var gameMusic = new Audio('http://martinolesen.codes/images/Game/GameMusic.mp3')
...
function draw() {
  ...
  for(let jump of enemy){
    ...
    if(d < 50){
      ...
      if(dist(-500, height - 185, jump.x+25, height - 185) < 50 && enemy.length <= 2 || dist(-50, height - 185, jump.x+25, height - 185) < 50 && enemy.length <= 1 ){
        enemy = [];
        newEnemy();
      }
    }
